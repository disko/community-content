...
-  Add a `docker-compose.yml` file
  ...
  <summary>Click here to view the code of the <kbd>docker-compose.yml</kbd> file</summary>
  ...
  services:
    traefik:
      ...
      command:
        ...
        - --certificatesresolvers.myresolver.acme.email=your@domain.tld
    ...
    vaultwarden:
      ...
      environment:
        ...
        SMTP_FROM: "sender email e.g: your@domain.tld"
